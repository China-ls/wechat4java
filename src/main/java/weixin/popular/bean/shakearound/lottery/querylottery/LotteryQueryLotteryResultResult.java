...
public class LotteryQueryLotteryResultResult {
     ...
     */
    @SerializedName("prize_count_limit")
     ...
     * 过期红包ticket数量
     */
    @SerializedName("expired_prizes")
    private Long expiredPrizes;

    /**
     * 已发放的红包ticket数量
     */
    @SerializedName("drawed_prizes")
    private Long drawedPrizes;

    /**
     * 可用的红包ticket数量
     */
    @SerializedName("available_prizes")
    private Long availablePrizes;

    /**
     * 已过期的红包金额总和
     */
    @SerializedName("expired_value")
    private Long expiredValue;

    /**
     * 已发放的红包金额总和
     */
    @SerializedName("drawed_value")
